...
async function main() {
  ...
  await db.insert(skills).values([
    { category: "Languages", name: "Java", level: 90, order: 1 },
    { category: "Languages", name: "Python", level: 80, order: 2 },
    { category: "Languages", name: "C++", level: 85, order: 3 },
    { category: "Languages", name: "JavaScript", level: 85, order: 4 },
    { category: "Languages", name: "HTML5", level: 95, order: 5 },
    { category: "Languages", name: "CSS", level: 90, order: 6 },
    { category: "Frameworks", name: "Spring Boot", level: 90, order: 7 },
    { category: "Frameworks", name: "ReactJS", level: 85, order: 8 },
    { category: "Frameworks", name: "NodeJS", level: 80, order: 9 },
    { category: "Frameworks", name: "Express", level: 80, order: 10 },
    { category: "Frameworks", name: "Bootstrap", level: 90, order: 11 },
    { category: "Frameworks", name: "Angular", level: 75, order: 12 },
    { category: "Libraries & Tools", name: "Tailwind CSS", level: 85, order: 13 },
    { category: "Libraries & Tools", name: "Material UI", level: 80, order: 14 },
    { category: "Libraries & Tools", name: "Redux", level: 75, order: 15 },
    { category: "Libraries & Tools", name: "Socket.io", level: 80, order: 16 },
    { category: "Databases", name: "MongoDB", level: 85, order: 17 },
    { category: "Databases", name: "MySQL", level: 80, order: 18 },
    { category: "DevOps & Cloud", name: "Docker", level: 75, order: 19 },
    { category: "DevOps & Cloud", name: "AWS (EC2)", level: 70, order: 20 },
    { category: "DevOps & Cloud", name: "Git", level: 90, order: 21 },
    { category: "DevOps & Cloud", name: "CI/CD", level: 75, order: 22 }
  ]);
